...
- [ ] T012 [P] [US2] Configurar monitor externo (UptimeRobot): checks a cada 1–5 min em `/robots.txt` (200 + keyword `Sitemap:`) e `/api/health` (200 + `"status":"ok"`), alerta de uptime/latência (C6, FR-005); documentar em `Docs/Obsidian/80-dev/`
