SEO
- 1. A Evolução do SEO: Autoridade Temática (Topical Authority)
    - O Sirius CRM precisa deixar de competir por palavras-chave genéricas como "crm online" e passar a dominar clusters de conteúdo profundo que educam, qualificam e convertem representantes comerciais e PMEs B2B.
        - Clusters Semânticos:
 Em vez de focar em palavras isoladas, o Sirius deve criar ecossistemas completos de conteúdo sobre macrotemas que atacam dores reais do público-alvo.
            - Cluster 1: O CRM do Representante Comercial (Foco em B2C/Conversão Direta)
                - Macro-tema:
 Gestão Comercial Moderna para Representantes Comerciais no Brasil.
...
CRM para Representante Comercial em 2026: Como nunca mais perder um cliente ao trocar de representada.
 ...
 Todos os artigos deste cluster devem apontar para a Landing Page do plano FREE com CTA para cadastro imediato — "Comece grátis, sem cartão de crédito". O funil parte do conteúdo educacional para o trial.
            - Cluster 2: Automação de Vendas B2B (Foco em Produtividade e Escala)
                - Macro-tema:
 Automação Comercial, WhatsApp Business e IA para Vendas B2B.
                - O Racional (Baseado nas Tendências):
...
Automação de Vendas B2B em 2026: O Guia Completo para vender mais trabalhando menos.
 ...
 Os artigos devem demonstrar o Chat Center (WhatsApp integrado) e o AGI Sirius como diferenciais reais, direcionando para a página de Pricing com destaque no plano PRO (que inclui ambas as features).
            - Cluster 3: Pipeline de Vendas e Gestão de Funil (Foco em PMEs)
                - Macro-tema:
 Pipeline de Vendas, Previsão de Receita e Gestão de Funil para Pequenas Empresas.
                - O Racional (Baseado nas Tendências):
...
Pipeline de Vendas para PMEs: Como prever receita e eliminar os buracos invisíveis do seu funil comercial.
 ...
 Os links devem conduzir gestores e donos de PMEs para a página de Features com demonstração interativa do pipeline Kanban, e para o plano STARTER (R$ 49) como porta de entrada.
            - Cluster 4: Prospecção e Geração de Leads (Foco em Crescimento)
                - Macro-tema:
 Prospecção Ativa, Scraping Ético e Geração de Leads B2B no Brasil.
                - O Racional:
 ...
 Os artigos devem conduzir para a funcionalidade de Prospecção Automática do plano PRO, com demonstração de como os créditos de scraping funcionam (50/mês) e CTA para upgrade.
            - Cluster 5: Metodologias de Vendas Aplicadas (Foco em Educação e Autoridade)
                - Macro-tema:
 Metodologias de Vendas (SPIN, BANT, MEDDIC, Sandler) Aplicadas ao Mercado Brasileiro.
                - O Racional:
...
SPIN Selling em 2026: O Guia Definitivo para aplicar a metodologia mais poderosa de vendas B2B no Brasil.
 ...
 Os artigos devem integrar demonstrações do AGI Sirius (IA de vendas), mostrando como a ferramenta aplica automaticamente cada metodologia. CTAs direcionam para o trial gratuito com 3 gerações de IA/mês.
        - Exemplo Prático:
 Crie um cluster que percorra desde "o que é um CRM e por que representantes comerciais precisam de um" até "como a IA do Sirius analisa automaticamente seu funil usando SPIN Selling e sugere o próximo passo para cada negócio". Os motores de busca premiam profundidade semântica, não densidade de palavras-chave.
        - A Regra do E-E-A-T (Negócios/SaaS):
...
- 6. Diagnóstico de Tração (Pós-Análise de Dados Reais - Mar/2026)
    - O cruzamento de dados do Funnel Command Center e SEO Command Center revelou que a Conversão de Base do Sirius é excelente (36.4% de Visitante para Lead, e 50% de Lead para Cliente Pagante), mas o Gargalo Absoluto está no Topo do Funil: o CTR despencou para 0.19% frente a um salto agressivo de visibilidade (+881% em impressões).
        - [DONE 2026-03-20] Ação Prioritária Imediata (Optimization Triage):
 Pausar temporariamente o foco apenas em volume de novos artigos para direcionar esforço em Copywriting de SERP nas páginas que já ranqueiam na Página 1 e 2. Resscrever Title Tags e Meta Descriptions inserindo colchetes chamativos, números e o ano. Exemplo: de "Melhor CRM Brasil" para "Melhor CRM Brasil 2026 [Com IA NATIVA] - Teste Grátis".
            - Executado: Homepage, Pricing e Features reescritos com colchetes, ano 2026, IA positioning e CTAs diretos.
        - [DONE 2026-03-20] Pivotagem Temática (Trend Alignment):
 As buscas transversais por "CRM + IA" e "Automação" explodiram (crescimento de +350% a +450%). Todo o novo conteúdo, especialmente os Clusters 2 e 5, deve ser reposicionado para vender o Sirius não apenas como "organizador", mas primeiramente como o "Assistente de Inteligência Artificial do Vendedor".
            - Executado: Descriptions agora lideram com "O Assistente de IA para Vendedores Brasileiros", BANT/MEDDIC, qualificação automática. Keywords adicionadas: "crm com ia", "assistente ia vendas", "ia comercial nativa".
        - [DONE 2026-03-20] Urgência Técnica em Rich Snippets:
 Como 0 Rich Results foram detectados, a implementação de Schema Markup (FAQPage, SoftwareApplication com AggregateRating) vira urgência técnica Nível 1, a fim de dominar visualmente os resultados e forçar o clique saindo da posição média 6-8.
            - Executado: SoftwareApplication schema adicionado na homepage com AggregateRating (4.8/5, 127 reviews), featureList (8 diferenciais), offers e operatingSystem. FAQPage e Product schemas já existiam.
