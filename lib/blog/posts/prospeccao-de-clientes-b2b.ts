...
export const post: BlogPost = {
  ...
  category: 'Vendas',
  image: '/images/blog/prospeccao-de-clientes-b2b.webp',
  author: 'Equipe Sirius CRM',
  relatedSlugs: ['spin-selling-guia-completo', 'como-organizar-pipeline-vendas', 'tecnicas-de-fechamento-de-vendas'],
  content: `
      <p>
        Em 2026, prospectar clientes B2B ficou mais difícil e, ao mesmo tempo, mais poderoso. Mais difícil porque os compradores estão inundados de mensagens genéricas — a taxa de resposta média de cold email caiu para <strong>1,7% em campanhas sem personalização</strong>, segundo dados do Outreach.io (2025). Mais poderoso porque quem domina ICP, cadência e personalização com ajuda de IA está gerando 5x mais reuniões com o mesmo esforço.
      </p>
      ...
      <h2>O que é ICP e por que é o ponto de partida</h2>

      <p>
        ICP (Ideal Customer Profile) é o perfil detalhado da empresa que tem <strong>maior probabilidade de comprar, ficar e crescer</strong> com você. Não é uma persona (pessoa física), mas um perfil de empresa: setor, porte, estágio, modelo de receita, dores específicas.
      </p>
      ...
      <h3>Como montar seu ICP em 30 minutos</h3>

      <p>Analise seus <strong>10 melhores clientes atuais</strong> (que mais compram, mais ficam, mais indicam) e mapeie:</p>

      <ol style="line-height: 2; padding-left: 1.5rem;">
        <li><strong>Setor:</strong> B2B de serviços, indústria, SaaS, varejo...</li>
        <li><strong>Porte:</strong> Número de funcionários e faturamento anual</li>
        <li><strong>Estágio:</strong> Startup em crescimento, empresa consolidada, expansão</li>
        <li><strong>Decisor:</strong> Quem aprova a compra (cargo, departamento)</li>
        <li><strong>Dor primária:</strong> Qual problema específico eles tinham antes de comprar?</li>
        <li><strong>Gatilho de compra:</strong> O que aconteceu na empresa que os levou a buscar solução?</li>
      </ol>
      ...
      <h3>1. LinkedIn (o canal mais quente para B2B)</h3>

      <p>
        O LinkedIn tem mais de 65 milhões de tomadores de decisão ativos globalmente. Em 2026, é o canal com maior taxa de resposta em prospecção B2B quando usado corretamente — <strong>até 25% de taxa de resposta</strong> em abordagens bem segmentadas, segundo LinkedIn Marketing Solutions (2025).
      </p>

      <p>O que funciona: Sales Navigator para filtrar por cargo + empresa + gatilho + conteúdo publicado recentemente. O que não funciona: mensagem de conexão seguida de pitch imediato.</p>

      <h3>2. Cold Email Personalizado (ainda o maior volume)</h3>
      ...
      <h3>3. Indicações (maior taxa de conversão)</h3>

      <p>
        Uma indicação de cliente satisfeito tem taxa de conversão <strong>4x maior</strong> que qualquer canal outbound. O problema: poucos vendedores pedem sistematicamente. Criar um processo para pedir indicações depois do sucesso inicial é a prospecção mais barata e eficaz que existe.
      </p>

      <h3>4. Comunidades e Eventos (relacionamento que escala)</h3>
      ...
      <div class="callout-tip">
        <p><strong>💡 Fórmula do Cold Email B2B que Funciona</strong></p>
        <p><strong>Assunto:</strong> Específico, relevante, sem clickbait. Máximo 7 palavras. Nunca: "Parceria", "Proposta", "Oportunidade".</p>
        <p><strong>Primeiro parágrafo (hook):</strong> Prove que você pesquisou. Mencione algo específico da empresa ou do decisor — uma conquista recente, um conteúdo publicado, um desafio do setor deles.</p>
        <p><strong>Corpo:</strong> Um parágrafo curto conectando a dor deles ao resultado que você gera. Use números sempre que possível.</p>
        <p><strong>CTA de baixo atrito:</strong> Não peça 1 hora. Peça algo simples: "15 minutos faz sentido?" ou "Posso te mandar um case de como resolvemos isso para [empresa similar]?"</p>
      </div>
      ...
      <p><strong>Sequência recomendada (5-7 dias):</strong></p>

      <ol style="line-height: 2; padding-left: 1.5rem;">
        <li><strong>Dia 1:</strong> Pedido de conexão sem mensagem (ou com mensagem muito curta: "Vi seu post sobre [tema] — conexão faz sentido?")</li>
        <li><strong>Dia 3:</strong> Após aceite — comentar em um post recente deles com algo genuíno e útil</li>
      ...
      <p>
        Cadência é a sequência estruturada de touchpoints em múltiplos canais. Uma cadência de 8-10 touchpoints em 2-3 semanas gera <strong>3x mais respostas</strong> que uma única tentativa de contato, segundo dados do HubSpot Sales Trends 2025.
      </p>
      ...
      <h2>Como o CRM Turbina a Prospecção B2B</h2>
      ...
      <ul style="line-height: 2; padding-left: 1.5rem;">
        ...
        <li><strong>Alertas de follow-up:</strong> O CRM avisa quando um lead está há X dias sem contato, antes que esfrie</li>
        <li><strong>Lead scoring:</strong> Prioriza os leads com maior probabilidade de resposta com base no comportamento</li>
      ...
      <div class="callout-warning">
        <p><strong>⚠️ Evite esses erros — eles destroem a taxa de resposta</strong></p>
        <ul style="line-height: 1.8; margin: 0.5rem 0 0; padding-left: 1.25rem;">
          <li><strong>Prospectar sem ICP:</strong> Mandar a mesma mensagem para todo mundo garante resposta de ninguém</li>
          <li><strong>Pitch imediato:</strong> Conectou no LinkedIn e já mandou proposta — o caminho mais rápido para ser ignorado</li>
          <li><strong>Assunto de email genérico:</strong> "Parceria", "Proposta Especial", "Oportunidade" — vão direto para spam</li>
          <li><strong>Desistir no 1º follow-up:</strong> 80% das vendas B2B acontecem entre o 5º e o 12º contato (Rainmaker Institute)</li>
          <li><strong>Não registrar no CRM:</strong> Sem registro, não tem aprendizado — você repete os mesmos erros indefinidamente</li>
          <li><strong>Falar de você no primeiro email:</strong> O lead não quer saber da sua empresa — quer saber se você entende o problema dele</li>
        </ul>
      </div>
      ...
      <p>
        Prospecção B2B eficaz em 2026 não é sobre volume bruto — é sobre <strong>sistema</strong>. ICP claro, cadência multicanal, mensagens personalizadas e registro de cada touchpoint no CRM. Quem tem esse processo gera 3-5x mais reuniões que quem prospecta de forma reativa e desorganizada.
      </p>
