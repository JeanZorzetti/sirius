...
export const post: BlogPost = {
  ...
  category: 'Vendas',
  image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=630&fit=crop&auto=format&q=80',
  author: 'Equipe Sirius CRM',
  relatedSlugs: ['melhor-crm-2026-comparativo', 'crm-automacao-vendas-guia-completo', 'kpis-de-vendas'],
  content: `
      <p>
      ...
      <div class="not-prose" style="background: #1e293b; padding: 1.5rem; border-radius: 0.75rem; margin: 2rem 0;">
        ...
        <ul style="margin: 0; padding-left: 1.25rem; line-height: 2; color: #ffffff;">
          ...
          <li><strong>Campos customizados</strong> por tipo de serviço (SEO, Mídia Paga, Social) eliminam perdas de informação entre equipes</li>
          <li>Alertas de churn para <strong>clientes sem interação há 30 dias</strong> evitam perdas silenciosas de contrato</li>
          <li>Agências com <strong>CRM estruturado</strong> têm taxa de renovação até 40% maior do que as que dependem de planilhas (Forrester, 2025)</li>
          <li>O <strong>Sirius CRM</strong> suporta multi-pipeline nativo com campos customizados por deal — sem configuração complexa</li>
        </ul>
      </div>

      <h2>Por que Agências de Marketing Precisam de CRM (Não Só Trello)</h2>
      ...
      <p>
        A diferença fundamental é o objeto que está sendo rastreado. No Trello, você rastreia <strong>o que precisa ser feito</strong>: criar o criativo, revisar o relatório, publicar a campanha. No CRM, você rastreia <strong>o que vai gerar receita</strong>: em que estágio está a proposta para o cliente X, qual é o valor em risco de churn, quanto do pipeline de renovação vai fechar esse mês.
      </p>
      ...
      <div class="callout-tip">
        <p><strong>Dica: quando criar um quarto pipeline</strong></p>
        <p>Agências que oferecem projetos pontuais (rebrand, produção de vídeo, auditoria) além de contratos recorrentes podem criar um quarto pipeline: "Projetos". Esse pipeline tem etapas como Briefing → Orçamento → Aprovação → Execução → Entrega Final → Upsell, sem a etapa de renovação. Isso evita que projetos pontuais poluam o pipeline de Prospecção (que é para novos clientes) e o de Renovação (que é para mensalistas).</p>
      </div>

      <h2>5 Funcionalidades de CRM que Agências Subutilizam</h2>
      ...
      <h3>1. Campos Customizados por Tipo de Serviço</h3>
      ...
      <h3>2. Automação de Follow-up para Propostas Enviadas</h3>
      ...
      <h3>4. Integração WhatsApp para Atendimento e Vendas</h3>
      ...
      <div class="callout-warning">
        <p><strong>Sinal de alerta: quando o CRM não está sendo usado de verdade</strong></p>
        <ul style="line-height: 1.8; margin: 0.5rem 0 0; padding-left: 1.25rem;">
          <li>Deals parados na mesma etapa há mais de 30 dias sem atividade registrada</li>
          <li>Campos obrigatórios em branco (tipo de serviço, valor contratual, data de vencimento)</li>
          <li>Clientes ativos sem nenhuma interação registrada nos últimos 45 dias</li>
          <li>Pipeline de renovação vazio apesar de ter clientes com contrato por vencer</li>
          <li>Histórico de reuniões e ligações zerado — sinal de que o time não registra atividades</li>
        </ul>
      </div>
      ...
      <h3>Ticket Médio por Tipo de Serviço</h3>
      ...
      <h3>Ciclo de Vendas para Novos Clientes</h3>
      ...
      <h2>Agência Pequena (até 5 pessoas): Como Começar com CRM Gratuito</h2>
