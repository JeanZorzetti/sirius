...
<strong>1. Abertura (5 min) — Script:</strong>
...
<strong>2. Perguntas de Situação (10 min) — Checklist Essencial:</strong>
...
<strong>3. Perguntas de Problema (15 min) — Perguntas-Chave:</strong>
...
<strong>4. Perguntas de Implicação (10 min) — Perguntas-Chave:</strong>
...
<strong>5. Perguntas de Necessidade de Solução (5 min) — Perguntas-Chave:</strong>
...
<strong>Script de Transição para Demo:</strong>
...
<FAQ question="SPIN funciona em vendas remotas (Zoom, Meet)?">
    <strong>Resposta:</strong> <strong>Sim</strong>, inclusive é mais fácil! Você pode ter o template aberto durante a call, gravar automaticamente para revisão, e compartilhar tela para mostrar ROI calculado.
  </FAQ>

<FAQ question="Qual a diferença entre SPIN e BANT?">
    SPIN foca em discovery profundo de dores (40-50 min), BANT foca em qualificação rápida (10-15 min). <strong>Melhor Abordagem:</strong> Use <strong>BANT primeiro</strong> (qualificação) → depois <strong>SPIN</strong> (discovery).
  </FAQ>

<FAQ question="Como medir ROI do treinamento SPIN?">
    <strong>Resposta:</strong> Acompanhe: Taxa Conversão SQL→Proposta, Duração Média Discovery, Problemas Identificados/Discovery, % Deals com ROI Calculado, Objeção "Está Caro", Ciclo de Vendas Médio, Ticket Médio. <strong>Meta Realista:</strong> +15-20% conversão em 3 meses.
  </FAQ>
</FAQAccordion>
