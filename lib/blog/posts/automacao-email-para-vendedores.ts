...
export const post: BlogPost = {
  ...
  content: `
      ...
      <div class="not-prose" style="background: var(--primary); padding: 1.5rem; border-radius: 0.75rem; margin: 2rem 0;">
        ...
        <ul style="margin: 0; padding-left: 1.25rem; line-height: 2; color: #ffffff;">
          ...
          <li>O <a href="/" style="color: var(--primary-foreground);">Sirius CRM</a> configura todos os 4 gatilhos em menos de 30 minutos</li>
        </ul>
      </div>
      ...
      <ol style="line-height: 2; padding-left: 1.5rem;">
        ...
        <li><strong>Templates de e-mail:</strong> Mensagens pré-escritas com variáveis personalizáveis (<code style="background: var(--muted); padding: 0.1rem 0.3rem; border-radius: 0.25rem;">&#123;&#123;nome&#125;&#125;</code>, <code style="background: var(--muted); padding: 0.1rem 0.3rem; border-radius: 0.25rem;">&#123;&#123;empresa&#125;&#125;</code>, <code style="background: var(--muted); padding: 0.1rem 0.3rem; border-radius: 0.25rem;">&#123;&#123;produto_interesse&#125;&#125;</code>)</li>
        <li><strong>Regras de timing:</strong> Definição de quando cada e-mail é enviado em relação ao evento gatilho</li>
      </ol>

      <p>
        No <a href="/" style="color: var(--foreground); text-decoration: underline;">Sirius CRM</a>, esses 4 gatilhos estão disponíveis na seção de Automações. Você configura o template, define o timing e ativa — a partir daí funciona para todos os leads de forma consistente.
      </p>
      ...
      <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0; font-family: monospace; font-size: 0.875rem; line-height: 1.9;">
        <p style="margin: 0; color: var(--foreground);"><strong>Assunto:</strong> Olá, &#123;&#123;primeiro_nome&#125;&#125; — suas informações estão aqui</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Olá, &#123;&#123;primeiro_nome&#125;&#125;,</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Recebi seu cadastro na &#123;&#123;nome_empresa_prospect&#125;&#125; — obrigado pelo interesse.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Em menos de 1 minuto, aqui está o que você precisa saber:</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">→ <strong>O que fazemos:</strong> &#123;&#123;descricao_produto_1_linha&#125;&#125;<br/>
        ...
        <br/>
        <p style="margin: 0; color: var(--foreground);">Você tem disponibilidade essa semana para uma conversa rápida? Aqui está meu link de agenda: &#123;&#123;link_agenda&#125;&#125;</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Att,<br/>&#123;&#123;nome_vendedor&#125;&#125;<br/>&#123;&#123;cargo&#125;&#125; | &#123;&#123;empresa&#125;&#125;<br/>&#123;&#123;telefone&#125;&#125;</p>
      </div>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 2rem 0;">
        <thead>
          <tr style="background: var(--muted);">
            <th style="padding: 0.75rem; border: 1px solid var(--border); text-align: left;">Horário</th>
            <th style="padding: 0.75rem; border: 1px solid var(--border); text-align: left;">Taxa de Abertura Média</th>
            <th style="padding: 0.75rem; border: 1px solid var(--border); text-align: left;">Observação</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>8h–10h (Terça ou Quarta)</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">34–41%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Melhor janela geral B2B</td>
          </tr>
          <tr style="background: var(--muted);">
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>11h–12h (Terça a Quinta)</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">29–35%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Segunda melhor janela</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>16h–17h (Terça e Quarta)</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">27–32%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Checagem final do dia</td>
          </tr>
          <tr style="background: var(--muted);">
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Segunda de manhã</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">18–22%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Inbox cheio do fim de semana</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Sexta após 14h</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">14–18%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Foco já no fim de semana</td>
          </tr>
        </tbody>
      </table>
      ...
      <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0; font-family: monospace; font-size: 0.875rem; line-height: 1.9;">
        <p style="margin: 0; color: var(--foreground);"><strong>Assunto:</strong> Resumo da nossa conversa + próximos passos</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;primeiro_nome&#125;&#125;,</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Obrigado pelo tempo hoje. Aqui está o resumo do que discutimos:</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);"><strong>Desafio principal identificado:</strong> &#123;&#123;desafio_mencionado&#125;&#125;</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);"><strong>O que discutimos como solução:</strong> &#123;&#123;solucao_discutida&#125;&#125;</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);"><strong>Próximos passos acordados:</strong><br/>
        ☐ &#123;&#123;acao_minha&#125;&#125; — até &#123;&#123;prazo_minha_acao&#125;&#125;<br/>
        ☐ &#123;&#123;acao_lead&#125;&#125; — até &#123;&#123;prazo_acao_lead&#125;&#125;</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Vou te enviar &#123;&#123;material_prometido&#125;&#125; até &#123;&#123;data_envio&#125;&#125;.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Alguma dúvida ou ajuste antes disso?</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;nome_vendedor&#125;&#125;</p>
      </div>

      <p>
        Note que os campos entre chaves duplas são preenchidos pelo vendedor no CRM antes de enviar (ou preenchidos automaticamente se o CRM integra com a ferramenta de reunião). No <a href="/" style="color: var(--foreground); text-decoration: underline;">Sirius CRM</a>, você registra os pontos da reunião em campos estruturados e o sistema monta o e-mail automaticamente.
      </p>
      ...
      <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0; font-family: monospace; font-size: 0.875rem; line-height: 1.9;">
        <p style="margin: 0; color: var(--foreground);"><strong>Assunto:</strong> &#123;&#123;primeiro_nome&#125;&#125; — mudou alguma coisa desde nossa última conversa?</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;primeiro_nome&#125;&#125;,</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Entramos em contato há algumas semanas sobre &#123;&#123;tema_conversa_anterior&#125;&#125; e entendo que pode não ter sido o momento certo.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Dois motivos para retomar:</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);"><strong>1. Novidade relevante:</strong> Lançamos &#123;&#123;nova_funcionalidade_ou_caso_sucesso&#125;&#125; que resolve exatamente &#123;&#123;problema_especifico_do_lead&#125;&#125; que você mencionou. Posso te mandar o resumo em 2 parágrafos?</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);"><strong>2. Mudança de contexto:</strong> Sua empresa fez &#123;&#123;evento_recente_empresa&#125;&#125; — isso muda o timing para avaliar &#123;&#123;solucao&#125;&#125;?</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Se não for o momento, diga uma palavra e não te incomodo mais por agora.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;nome_vendedor&#125;&#125;</p>
      </div>
      ...
      <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0; font-family: monospace; font-size: 0.875rem; line-height: 1.9;">
        <p style="margin: 0; color: var(--foreground);"><strong>Assunto:</strong> Precisa de mais tempo para analisar? (sem pressão)</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;primeiro_nome&#125;&#125;,</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Enviei a proposta há 2 dias — pode ter ficado perdida no fluxo de emails, o que acontece com todo mundo.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Estou reenviando aqui: &#123;&#123;link_proposta&#125;&#125;</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">Se precisar de mais tempo ou tiver alguma dúvida sobre algum ponto antes de analisar, é só responder aqui.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">E se o timing não estiver certo agora, também tudo bem — me diz em quanto tempo faz mais sentido retomar.</p>
        <br/>
        <p style="margin: 0; color: var(--foreground);">&#123;&#123;nome_vendedor&#125;&#125;</p>
      </div>
      ...
      <p>
        O <a href="/" style="color: var(--foreground); text-decoration: underline;">Sirius CRM</a> tem módulo de automação de e-mail integrado ao pipeline de vendas. A configuração dos 4 gatilhos leva menos de 30 minutos:
      </p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 2rem 0;">
        <thead>
          <tr style="background: var(--muted);">
            ...
            <th style="padding: 0.75rem; border: 1px solid var(--border); text-align: left;">Benchmark B2B</th>
            <th style="padding: 0.75rem; border: 1px solid var(--border); text-align: left;">O que fazer se estiver abaixo</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Taxa de abertura</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">25–40%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Testar 3 variações de assunto em A/B</td>
          </tr>
          <tr style="background: var(--muted);">
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Taxa de clique</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">3–8%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Revisar CTA — deve ser um único e claro</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Taxa de resposta</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">5–15% (cold) / 40–65% (pós-reunião)</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Reescrever primeiro parágrafo e CTA</td>
          </tr>
          <tr style="background: var(--muted);">
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Taxa de unsubscribe</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">&lt; 0,5%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Revisar segmentação — lista muito ampla</td>
          </tr>
          <tr>
            <td style="padding: 0.75rem; border: 1px solid var(--border);"><strong>Taxa de conversão (resposta → reunião)</strong></td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">20–35%</td>
            <td style="padding: 0.75rem; border: 1px solid var(--border);">Revisar proposta de valor e qualificação inicial</td>
          </tr>
        </tbody>
      </table>
      ...
      <details style="border: 1px solid var(--border); border-radius: 0.5rem; padding: 1rem; margin-bottom: 0.75rem;">
        <summary style="font-weight: 600; cursor: pointer; color: var(--foreground); list-style: revert;">Automação de e-mail não parece artificial para o lead?</summary>
      ...
      <details style="border: 1px solid var(--border); border-radius: 0.5rem; padding: 1rem; margin-bottom: 0.75rem;">
        <summary style="font-weight: 600; cursor: pointer; color: var(--foreground); list-style: revert;">Quantos e-mails automáticos posso enviar para o mesmo lead?</summary>
      ...
      <details style="border: 1px solid var(--border); border-radius: 0.5rem; padding: 1rem; margin-bottom: 0.75rem;">
        <summary style="font-weight: 600; cursor: pointer; color: var(--foreground); list-style: revert;">E-mail de vendas automatizado vai para spam?</summary>
      ...
      <details style="border: 1px solid var(--border); border-radius: 0.5rem; padding: 1rem; margin-bottom: 2rem;">
        <summary style="font-weight: 600; cursor: pointer; color: var(--foreground); list-style: revert;">Como medir se a automação está gerando ROI real?</summary>
      ...
      <p>
        O próximo passo: configure o gatilho de welcome no <a href="/" style="color: var(--foreground); text-decoration: underline;">Sirius CRM</a> hoje. É o de maior impacto, mais simples de configurar e começa a gerar resultado no mesmo dia.
      </p>
  ...
  contentEn: `
      ...
      <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.5rem; padding: 1.25rem; margin: 1rem 0; font-family: monospace; font-size: 0.875rem;">
