...
<div style="background: var(--primary); border-radius: 1rem; padding: 1.75rem 2rem; margin: 2rem 0;">
  <p style="font-size: 0.75rem; font-weight: 700; color: var(--primary-foreground); text-transform: uppercase; letter-spacing: 0.1em; margin: 0 0 0.75rem;">TL;DR — Leitura de 30 segundos</p>
  <ul style="margin: 0; padding-left: 1.25rem; space-y: 0.5rem;">
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">A Meta está banindo ativamente contas que usam APIs não oficiais (Evolution API, Baileys, Whatsmeow)</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">A API Oficial (Meta Cloud API) é a única integração homologada — sem risco de banimento</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">Requer Meta Business Manager verificada + número dedicado + app no Facebook Developers</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem;">O Sirius CRM é um dos únicos CRMs brasileiros com integração nativa à API Oficial</li>
  </ul>
</div>
...
<div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0;">
  <p style="font-weight: 700; color: var(--foreground); margin: 0 0 0.75rem;">⚠️ Por que a Meta está agindo agora com mais força?</p>
  <div style="display: grid; gap: 0.75rem;">
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700; shrink: 0;">1.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Fraude e spam em escala:</strong> APIs não oficiais são a principal ferramenta de golpistas que disparam mensagens em massa fingindo ser bancos, Correios e órgãos governamentais.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700; shrink: 0;">2.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Receita:</strong> A Meta monetiza a API Oficial por volume de conversas. Cada empresa que usa a versão gratuita não oficial é receita perdida.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700; shrink: 0;">3.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Regulação:</strong> Com a LGPD e o GDPR europeu, a Meta precisa controlar o fluxo de dados que passa pelos seus servidores. APIs não oficiais criam um buraco negro de compliance.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700; shrink: 0;">4.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Detecção melhorou:</strong> Os algoritmos de detecção de comportamento não humano ficaram muito mais sofisticados em 2025. Padrões de digitação uniformes, envio em lote e conexões via servidor são facilmente identificados.</p>
    </div>
  </div>
</div>
  ...
  <table style="width: 100%; border-collapse: collapse; font-size: 0.9375rem;">
    <thead>
      <tr style="background: var(--muted);">
        <th style="padding: 0.875rem 1rem; text-align: left; border-bottom: 2px solid var(--border); color: var(--foreground); font-weight: 700;">Critério</th>
        <th style="padding: 0.875rem 1rem; text-align: center; border-bottom: 2px solid var(--border); color: var(--foreground); font-weight: 700;">API Oficial Meta</th>
        <th style="padding: 0.875rem 1rem; text-align: center; border-bottom: 2px solid var(--border); color: var(--pulso-escuro); font-weight: 700;">Evolution / Baileys / Whatsmeow</th>
      </tr>
    </thead>
    <tbody>
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Risco de banimento</td>
      ...
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Termos de uso da Meta</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Depende de celular conectado</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Não</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">🔴 Sim</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Uptime garantido</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Status de entrega (entregue/lido)</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Nativo</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">⚠️ Parcial</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Templates de mensagem proativa</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Multiagente no mesmo número</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Nativo</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">⚠️ Via workaround</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Custo</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Complexidade de setup</td>
      ...
      <tr style="background: #fafafa;">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Conformidade LGPD</td>
...
<div style="display: grid; gap: 1rem; margin: 1.5rem 0;">
  <div style="display: flex; gap: 1rem; align-items: flex-start; background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="background: var(--primary); color: white; font-weight: 700; font-size: 0.875rem; width: 2rem; height: 2rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">1</div>
    <div>
      <p style="margin: 0 0 0.25rem; font-weight: 600; color: var(--foreground);">Cliente envia mensagem</p>
      <p style="margin: 0; color: var(--foreground); font-size: 0.875rem;">O cliente digita uma mensagem no WhatsApp normalmente. Para ele, não há diferença alguma.</p>
    </div>
  </div>
  <div style="display: flex; gap: 1rem; align-items: flex-start; background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="background: var(--primary); color: white; font-weight: 700; font-size: 0.875rem; width: 2rem; height: 2rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">2</div>
    <div>
      <p style="margin: 0 0 0.25rem; font-weight: 600; color: var(--foreground);">Meta recebe e encaminha via Webhook</p>
      <p style="margin: 0; color: var(--foreground); font-size: 0.875rem;">Os servidores da Meta recebem a mensagem e fazem um POST para o webhook configurado no seu sistema — em milissegundos.</p>
    </div>
  </div>
  <div style="display: flex; gap: 1rem; align-items: flex-start; background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="background: var(--primary); color: white; font-weight: 700; font-size: 0.875rem; width: 2rem; height: 2rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">3</div>
    <div>
      <p style="margin: 0 0 0.25rem; font-weight: 600; color: var(--foreground);">CRM processa e exibe</p>
      <p style="margin: 0; color: var(--foreground); font-size: 0.875rem;">O CRM recebe o webhook, identifica o contato, cria a conversa e notifica o vendedor responsável — tudo em tempo real.</p>
    </div>
  </div>
  <div style="display: flex; gap: 1rem; align-items: flex-start; background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="background: var(--primary); color: white; font-weight: 700; font-size: 0.875rem; width: 2rem; height: 2rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">4</div>
    <div>
      <p style="margin: 0 0 0.25rem; font-weight: 600; color: var(--foreground);">Vendedor responde pelo CRM</p>
      <p style="margin: 0; color: var(--foreground); font-size: 0.875rem;">O vendedor digita a resposta no CRM. O sistema faz uma chamada à API da Meta, que entrega a mensagem ao cliente via WhatsApp.</p>
    </div>
  </div>
  <div style="display: flex; gap: 1rem; align-items: flex-start; background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="background: var(--primary); color: white; font-weight: 700; font-size: 0.875rem; width: 2rem; height: 2rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">5</div>
    <div>
      <p style="margin: 0 0 0.25rem; font-weight: 600; color: var(--foreground);">Status em tempo real</p>
      <p style="margin: 0; color: var(--foreground); font-size: 0.875rem;">A Meta envia webhooks de status: mensagem enviada → entregue → lida. O CRM atualiza os ícones de entrega automaticamente.</p>
    </div>
  </div>
</div>
...
<div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0;">
  <p style="font-weight: 700; color: var(--foreground); margin: 0 0 1rem;">💰 Tipos de conversa e janelas</p>
  <div style="display: grid; gap: 0.75rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; background: white; border: 1px solid var(--border); border-radius: 0.5rem; padding: 0.875rem 1rem;">
      <div>
        <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Conversa de Serviço</p>
        <p style="color: var(--foreground); font-size: 0.8125rem; margin: 0;">Cliente inicia contato — janela de 24h para respostas livres</p>
      </div>
      <span style="color: var(--foreground); font-weight: 700; font-size: 0.9375rem;">~R$ 0,06</span>
    </div>
    <div style="display: flex; justify-content: space-between; align-items: center; background: white; border: 1px solid var(--border); border-radius: 0.5rem; padding: 0.875rem 1rem;">
      <div>
        <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Conversa de Marketing</p>
        <p style="color: var(--foreground); font-size: 0.8125rem; margin: 0;">Empresa inicia com template de promoção/engajamento</p>
      </div>
      <span style="color: var(--foreground); font-weight: 700; font-size: 0.9375rem;">~R$ 0,25</span>
    </div>
    <div style="display: flex; justify-content: space-between; align-items: center; background: white; border: 1px solid var(--border); border-radius: 0.5rem; padding: 0.875rem 1rem;">
      <div>
        <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Conversa de Utilidade</p>
        <p style="color: var(--foreground); font-size: 0.8125rem; margin: 0;">Templates transacionais (confirmação de pedido, boleto, etc.)</p>
      </div>
      <span style="color: var(--foreground); font-weight: 700; font-size: 0.9375rem;">~R$ 0,05</span>
    </div>
    <div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.5rem; padding: 0.875rem 1rem;">
      <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">✅ 1.000 conversas de serviço/mês — GRÁTIS</p>
      <p style="color: var(--foreground); font-size: 0.8125rem; margin: 0;">Ideal para empresas que recebem contato inbound dos clientes</p>
    </div>
  </div>
</div>
...
<div style="display: grid; gap: 0.75rem; margin: 1.5rem 0;">
  <div style="display: flex; gap: 0.875rem; align-items: flex-start; padding: 1rem; background: white; border: 1px solid var(--border); border-radius: 0.75rem;">
    <span style="font-size: 1.375rem; flex-shrink: 0;">📱</span>
    <div>
      <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Chip virgem</p>
      <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Um número de telefone que <strong>nunca foi usado</strong> no WhatsApp — nem no app pessoal, nem no Business App. Qualquer histórico anterior impede o registro na API.</p>
    </div>
  </div>
  <div style="display: flex; gap: 0.875rem; align-items: flex-start; padding: 1rem; background: white; border: 1px solid var(--border); border-radius: 0.75rem;">
    <span style="font-size: 1.375rem; flex-shrink: 0;">🏢</span>
    <div>
      <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Meta Business Manager verificada</p>
      <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Conta empresarial na Meta com verificação de negócio concluída (CNPJ). Sem verificação, você não consegue gerar tokens de sistema.</p>
    </div>
  </div>
  <div style="display: flex; gap: 0.875rem; align-items: flex-start; padding: 1rem; background: white; border: 1px solid var(--border); border-radius: 0.75rem;">
    <span style="font-size: 1.375rem; flex-shrink: 0;">👨‍💻</span>
    <div>
      <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Acesso ao Facebook Developers</p>
      <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Você vai precisar criar um app do tipo "Business" em developers.facebook.com e adicionar o produto WhatsApp a ele.</p>
    </div>
  </div>
  <div style="display: flex; gap: 0.875rem; align-items: flex-start; padding: 1rem; background: white; border: 1px solid var(--border); border-radius: 0.75rem;">
    <span style="font-size: 1.375rem; flex-shrink: 0;">🔑</span>
    <div>
      <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.25rem;">Token de sistema permanente</p>
      <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Tokens temporários expiram em 24 horas. Para uso em produção, você precisa criar um usuário do sistema no Meta Business Manager e gerar um token permanente com as permissões corretas.</p>
    </div>
  </div>
</div>
...
<ol style="margin: 1.5rem 0; padding-left: 1.5rem; display: grid; gap: 1rem;">
  <li style="color: var(--foreground);">
    <strong style="color: var(--foreground);">Phone Number ID</strong> — identificador único do seu número na plataforma Meta. Encontrado em: Facebook Developers → seu app → WhatsApp → Configuração de API.
  </li>
  <li style="color: var(--foreground);">
    <strong style="color: var(--foreground);">Business Account ID (WABA ID)</strong> — ID da sua conta WhatsApp Business. Na mesma tela do Phone Number ID.
  </li>
  <li style="color: var(--foreground);">
    <strong style="color: var(--foreground);">Access Token permanente</strong> — gerado via usuário do sistema no Meta Business Manager com permissões <code style="background: var(--muted); padding: 0.125rem 0.375rem; border-radius: 0.25rem; font-size: 0.8125rem;">whatsapp_business_messaging</code> e <code style="background: var(--muted); padding: 0.125rem 0.375rem; border-radius: 0.25rem; font-size: 0.8125rem;">whatsapp_business_management</code>.
  </li>
  <li style="color: var(--foreground);">
    <strong style="color: var(--foreground);">Webhook Verify Token</strong> — uma string que você cria e que a Meta usa para validar seu endpoint de webhook.
  </li>
</ol>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">⚡</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">Status em tempo real</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Veja exatamente quando a mensagem foi entregue e lida, diretamente na timeline do negócio no CRM.</p>
  </div>
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">👥</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">Atendimento em equipe</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Múltiplos vendedores atendem pelo mesmo número sem conflito, com histórico compartilhado.</p>
  </div>
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">🔔</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">Notificações inteligentes</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Alertas de novas mensagens diretamente no CRM. Nenhuma conversa fica sem resposta por descuido.</p>
  </div>
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">📋</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">Histórico vinculado ao contato</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Todo o histórico de WhatsApp fica na ficha do contato no CRM. Troca de vendedor? Contexto preservado.</p>
  </div>
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">🕐</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">24/7 sem celular</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Não depende de nenhum celular ligado. Férias, fim de semana, troca de aparelho — o número continua operando.</p>
  </div>
  <div style="background: white; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.75rem;">📊</div>
    <p style="font-weight: 600; color: var(--foreground); margin: 0 0 0.5rem;">Métricas de atendimento</p>
    <p style="color: var(--muted-foreground); font-size: 0.875rem; margin: 0;">Tempo médio de resposta, volume por vendedor, conversas abertas — tudo mensurável.</p>
  </div>
</div>
...
<div style="display: grid; gap: 0.875rem; margin: 1.5rem 0;">
  <details style="background: #fafafa; border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.25rem; cursor: pointer;">
    <summary style="font-weight: 600; color: var(--foreground); list-style: none; display: flex; justify-content: space-between; align-items: center;">
      Posso migrar meu número atual para a API Oficial?
    </summary>
    <p style="color: var(--foreground); font-size: 0.9375rem; margin: 0.875rem 0 0; line-height: 1.6;">
...
<div style="background: var(--primary); border-radius: 1rem; padding: 2rem; margin: 2.5rem 0; text-align: center;">
  <p style="font-size: 1.5rem; font-weight: 800; color: var(--primary-foreground); margin: 0 0 0.75rem; line-height: 1.3;">
  ...
  <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
    ...
    <a href="/dashboard/settings/integrations/whatsapp-official" style="display: inline-block; background: transparent; color: var(--primary-foreground); padding: 0.75rem 1.75rem; border-radius: 0.5rem; text-decoration: none; font-weight: 700; font-size: 0.9375rem; border: 1px solid var(--border);">
...
<div style="background: var(--primary); border-radius: 1rem; padding: 1.75rem 2rem; margin: 2rem 0;">
  <p style="font-size: 0.75rem; font-weight: 700; color: var(--primary-foreground); text-transform: uppercase; letter-spacing: 0.1em; margin: 0 0 0.75rem;">TL;DR — 30 second read</p>
  <ul style="margin: 0; padding-left: 1.25rem; space-y: 0.5rem;">
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">Meta is actively banning accounts using unofficial APIs (Evolution API, Baileys, Whatsmeow)</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">The Official API (Meta Cloud API) is the only approved integration — no ban risk</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem; margin-bottom: 0.5rem;">Requires verified Meta Business Manager + dedicated number + app on Facebook Developers</li>
    <li style="color: var(--primary-foreground); font-size: 0.9375rem;">Sirius CRM is one of the only Brazilian CRMs with native integration to the Official API</li>
  </ul>
</div>
...
<div style="background: var(--muted); border: 1px solid var(--border); border-radius: 0.75rem; padding: 1.5rem; margin: 1.5rem 0;">
  <p style="font-weight: 700; color: var(--foreground); margin: 0 0 0.75rem;">⚠️ Why is Meta acting more forcefully now?</p>
  <div style="display: grid; gap: 0.75rem;">
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700;">1.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Fraud and spam at scale:</strong> Unofficial APIs are the primary tool of scammers who blast mass messages pretending to be banks, postal services, and government agencies.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700;">2.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Revenue:</strong> Meta monetizes the Official API by conversation volume. Every company using the free unofficial version is lost revenue.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700;">3.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Regulation:</strong> With LGPD and European GDPR, Meta needs to control the data flow through its servers. Unofficial APIs create a compliance black hole.</p>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start;">
      <span style="color: var(--pulso-escuro); font-weight: 700;">4.</span>
      <p style="margin: 0; color: var(--foreground); font-size: 0.9375rem;"><strong>Detection improved:</strong> Non-human behavior detection algorithms became much more sophisticated in 2025. Uniform typing patterns, batch sending, and server connections are easily identified.</p>
    </div>
  </div>
</div>
...
<div style="overflow-x: auto; margin: 1.5rem 0;">
  <table style="width: 100%; border-collapse: collapse; font-size: 0.9375rem;">
    <thead>
      <tr style="background: var(--muted);">
        <th style="padding: 0.875rem 1rem; text-align: left; border-bottom: 2px solid var(--border); color: var(--foreground); font-weight: 700;">Criterion</th>
        <th style="padding: 0.875rem 1rem; text-align: center; border-bottom: 2px solid var(--border); color: var(--foreground); font-weight: 700;">Official Meta API</th>
        <th style="padding: 0.875rem 1rem; text-align: center; border-bottom: 2px solid var(--border); color: var(--pulso-escuro); font-weight: 700;">Evolution / Baileys / Whatsmeow</th>
      </tr>
    </thead>
    <tbody>
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Ban risk</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Zero</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">🔴 High and growing</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Meta Terms of Service</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Depends on connected phone</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ No</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">🔴 Yes</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Guaranteed uptime</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Delivery status (delivered/read)</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Native</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">⚠️ Partial</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Proactive message templates</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Multi-agent on same number</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">✅ Native</td>
        <td style="padding: 0.875rem 1rem; text-align: center;">⚠️ Via workaround</td>
      </tr>
      <tr style="background: #fafafa; border-bottom: 1px solid var(--border);">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Cost</td>
      ...
      <tr style="background: #fafafa;">
        <td style="padding: 0.875rem 1rem; color: var(--foreground); font-weight: 500;">Data compliance</td>
...
<ol style="margin: 1.5rem 0; padding-left: 1.5rem; display: grid; gap: 1rem;">
  <li style="color: var(--foreground);"><strong style="color: var(--foreground);">Phone Number ID</strong> — unique identifier for your number on the Meta platform.</li>
  <li style="color: var(--foreground);"><strong style="color: var(--foreground);">Business Account ID (WABA ID)</strong> — ID of your WhatsApp Business account.</li>
  <li style="color: var(--foreground);"><strong style="color: var(--foreground);">Permanent Access Token</strong> — generated via system user in Meta Business Manager.</li>
  <li style="color: var(--foreground);"><strong style="color: var(--foreground);">Webhook Verify Token</strong> — a string you create that Meta uses to validate your webhook endpoint.</li>
</ol>
