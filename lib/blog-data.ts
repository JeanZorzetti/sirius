...
<div style="display: flex; flex-wrap: wrap; gap: 1rem; margin: 2rem 0; align-items: center;">
  ...
  <button onclick="if (navigator.share) { navigator.share({ title: 'SPIN Selling - Guia Completo 2026', text: 'Guia completo de SPIN Selling com 100+ perguntas práticas e templates gratuitos', url: window.location.href }).catch((err) => { if (err.name !== 'AbortError') console.error('Erro ao compartilhar:', err); }); } else { alert('Compartilhamento não disponível no seu navegador. Use os botões de WhatsApp ou LinkedIn.'); }" style="display: inline-flex; align-items: center; gap: 0.5rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 0.875rem 1.5rem; border-radius: 0.5rem; border: none; font-weight: 600; transition: all 0.2s; box-shadow: 0 2px 4px rgba(102, 126, 234, 0.2); cursor: pointer;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 8px rgba(102, 126, 234, 0.3)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 2px 4px rgba(102, 126, 234, 0.2)'">
        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z"/></svg>
        Compartilhar
      </button>
</div>
