    ...
    <form onSubmit={handleSubmit}>
            ...
            {[1, 2, 3].map(s => (
              <div key={s} className="flex items-center gap-2">
                <div className={cn(
                  ...
                  s === step && "bg-primary text-white ring-2 ring-ring ring-offset-2 ring-offset-zinc-900",
          ...
          <>
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-muted border-border text-foreground"
              />
              <p className="text-xs text-muted-foreground">Seu número principal para contato.</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  required
                  className="w-full h-10 rounded-md bg-muted border border-border text-foreground px-3 pr-8 text-sm appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring focus:border-foreground"
                >
        ...
        {step === 3 && (
          <>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">Opcional. Nos ajuda a personalizar sua experiência.</p>
            </div>
      ...
      <CardFooter className="flex flex-col gap-4">
        ...
        <div className="text-center text-sm text-muted-foreground">
          Já tem uma conta? <Link href="/login" className="text-muted-foreground hover:text-destaque">Entrar</Link>
        </div>
      </CardFooter>
    </form>
  )
